...
VL_MODULE(VInstructionMemory) {
  public:
    ...
    VL_SIG(InstructionMemory__DOT__mem___05FT_12_data,31,0);
  ...
  public:
    ...
    static void	_combo__TOP__4(VInstructionMemory__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void	_settle__TOP__3(VInstructionMemory__Syms* __restrict vlSymsp);
    ...
    static void	traceChgThis__3(VInstructionMemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
