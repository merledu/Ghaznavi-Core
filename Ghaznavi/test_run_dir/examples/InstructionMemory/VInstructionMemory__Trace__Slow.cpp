...
void VInstructionMemory::traceInitThis__1(VInstructionMemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBus  (c+4,"io_wrAddr",-1,31,0);
	vcdp->declBus  (c+5,"io_rdData",-1,31,0);
	vcdp->declBit  (c+2,"InstructionMemory clock",-1);
	vcdp->declBit  (c+3,"InstructionMemory reset",-1);
	vcdp->declBus  (c+4,"InstructionMemory io_wrAddr",-1,31,0);
	vcdp->declBus  (c+5,"InstructionMemory io_rdData",-1,31,0);
	...
	vcdp->declBus  (c+1,"InstructionMemory mem__T_12_data",-1,31,0);
	vcdp->declBus  (c+6,"InstructionMemory mem__T_12_addr",-1,9,0);
	vcdp->declBit  (c+2,"InstructionMemory BindsTo_0_InstructionMemory_Inst clock",-1);
	vcdp->declBit  (c+3,"InstructionMemory BindsTo_0_InstructionMemory_Inst reset",-1);
	vcdp->declBus  (c+4,"InstructionMemory BindsTo_0_InstructionMemory_Inst io_wrAddr",-1,31,0);
	vcdp->declBus  (c+5,"InstructionMemory BindsTo_0_InstructionMemory_Inst io_rdData",-1,31,0);
    }
}
...
void VInstructionMemory::traceFullThis__1(VInstructionMemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->fullBus  (c+1,(vlTOPp->InstructionMemory__DOT__mem___05FT_12_data),32);
	vcdp->fullBit  (c+2,(vlTOPp->clock));
	vcdp->fullBit  (c+3,(vlTOPp->reset));
	vcdp->fullBus  (c+4,(vlTOPp->io_wrAddr),32);
	vcdp->fullBus  (c+5,(vlTOPp->io_rdData),32);
